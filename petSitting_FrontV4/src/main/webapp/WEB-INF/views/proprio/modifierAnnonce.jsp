...
<p> <h2> Propriétaire > Modifier mes annonces </h2> </p> 

<p> <h3> Modifier mes annonces </h3> </p> 

	Vous voulez modifier une annonce. Voici la liste de vos annonces, veuillez en sélectionner une en cliquant sur le titre :
...
<c:forEach items="${ listeAnnonce }" var="ann">
	<tr>
		<td onClick="choixAnnonce" > ${ann.titre} </td>
		<td> ${ann.msg} </td>
	</tr>
</c:forEach>
