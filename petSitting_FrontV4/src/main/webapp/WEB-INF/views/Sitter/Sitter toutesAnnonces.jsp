...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/CSSpetsitting.css">ing.css">
...
<p><h2> Pet-sitter > Consulter toutes les annonces </h2></p> 

<p><h3> Consulter toutes les annonces </h3></p> 

Voici la liste des annonces existantes :
